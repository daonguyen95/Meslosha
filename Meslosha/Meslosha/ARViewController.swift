...
open class ARViewController: UIViewController, ARTrackingManagerDelegate
{
    open override func viewDidLoad() {
        ...
        let plusImage = UIImageView.init(frame: CGRect.init(x: screenWidth/2 - 25, y: screenHeight/2 - 25, width: 50, height: 50))
        plusImage.image = UIImage.init(named: "plus-icon")
        self.view.addSubview(plusImage)
        self.view.bringSubview(toFront: plusImage)
    }
